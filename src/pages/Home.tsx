      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
          {banners.length > 0 ? (
            ...
            <div>
              <TextReveal
                text="Your Trusted Skincare Pharmacy"
                tag="h1"
                className="apple-hero-heading text-gray-900 dark:text-white mb-6"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal animation="fade-up">
            <div className="text-center mb-12">
              <TextReveal text="Why Choose Us" tag="h2" className="section-heading" />
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <ScrollReveal animation="blur-in">
              <div className="text-center mb-12">
                <TextReveal text="Featured Products" tag="h2" className="section-heading" />
        ...
        <section className="py-20 bg-gradient-to-r from-emerald-600 to-teal-600">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <ScrollReveal animation="zoom-in">
              <TextReveal
                text="Ready to Transform Your Skincare Routine?"
                tag="h2"
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <MagneticButton as="a" href="/products" className="bg-white text-emerald-700 hover:bg-emerald-50 font-semibold px-8 py-3 rounded-lg transition-all shadow-lg apple-press">
                  Shop Now
                </MagneticButton>
                <MagneticButton as="a" href="/about" className="border-2 border-white text-white hover:bg-white/10 font-semibold px-8 py-3 rounded-lg transition-all apple-press">
                  Learn More
                </MagneticButton>
              </div>
            </ScrollReveal>
